...
// https://github.com/ignis-runtime/wazero/tree/main/examples/basic
func Example() {
	...
	mod, err := r.InstantiateWithConfig(ctx, addWasm, NewModuleConfig().WithStartFunctions("_initialize"))
	if err != nil {
		log.Panicln(err)
	}
