...
func ExampleCoreFeaturesThreads() {
	...
	cfg := wazero.NewRuntimeConfig().WithCoreFeatures(api.CoreFeaturesV2 | CoreFeaturesThreads)
...
func ExampleCoreFeaturesTailCall() {
	...
	cfg := wazero.NewRuntimeConfig().WithCoreFeatures(api.CoreFeaturesV2 | CoreFeaturesTailCall)
