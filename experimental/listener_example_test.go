...
func (u uniqGoFuncs) NewFunctionListener(def api.FunctionDefinition) FunctionListener {
...
func (u uniqGoFuncs) Before(ctx context.Context, _ api.Module, def api.FunctionDefinition, _ []uint64, _ StackIterator) {
...
func Example_customListenerFactory() {
	...
	ctx := WithFunctionListenerFactory(context.Background(), u)
...
func (s *fakeStackIterator) Function() InternalFunction {
...
func (s *fakeStackIterator) ProgramCounter() ProgramCounter {
	return ProgramCounter(s.pc)
}

var _ StackIterator = &fakeStackIterator{}
