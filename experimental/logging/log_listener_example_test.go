...
func Example_newHostLoggingListenerFactory() {
	...
	ctx := experimental.WithFunctionListenerFactory(context.Background(),
		NewHostLoggingListenerFactory(os.Stdout, LogScopeAll))
...
func Example_newLoggingListenerFactory() {
	...
	ctx := experimental.WithFunctionListenerFactory(context.Background(), NewLoggingListenerFactory(os.Stdout))
