...
export functions using [HostModuleBuilder](https://pkg.go.dev/github.com/ASparkOfFire/wazero#HostModuleBuilder) and how a
...
[wasi package](https://pkg.go.dev/github.com/ASparkOfFire/wazero/wasi).
